                                        ...
                                        <div class="min-w-0 flex-1 z-10">
                                            ...
                                            <div class="mt-1">
                                                @if ($product->is_unlimited_stock)
                                                    <flux:badge size="xs" color="purple" inset="top bottom">
                                                        {{ __('Tanpa Stok') }}</flux:badge>
            ...
            <flux:modal wire:model.self="showConfirmModal" class="max-w-2xl">
                <form wire:submit="save" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <flux:button variant="filled" href="/transactions/{{ $this->transaction->id }}/receipt"
                            target="_blank">
                            {{ __('Print Receipt') }}
                        </flux:button>
